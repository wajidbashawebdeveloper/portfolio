...
// Update the year by adding 1 to the current year

document.getElementById("yearpassing").innerHTML= currentDate.getFullYear()
...
function onSubmitForm() {
    ...
    alert("")
    emailjs.send(
      "service_uqewgf7","template_6x1sayc",{
    ...
    // You can include any code here to process form data or perform other actions
}
